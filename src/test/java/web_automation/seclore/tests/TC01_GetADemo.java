...
public class TC01_GetADemo extends TestBase {
    ...
    public void verifyGetADemoPage(String businessEmail, String firstName, String lastName, String companyName, String jobTitle, String phoneNumber, String country) {
        ...
        if (getADemoPage.ifPesonalisedDemoIframeIsDisplayed()) {
            test.log(Status.PASS, "Pesonalised demo iframe is displayed");
            logger.info("Pesonalised demo iframe is displayed");
            getADemoPage.switchToPesonalisedDemoIframe();
            ...
            test.log(Status.FAIL, "Pesonalised demo iframe is not displayed");
